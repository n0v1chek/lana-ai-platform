              ...
              <table className="w-full border-collapse border border-slate-300 dark:border-slate-600 text-left">
                <thead className="bg-slate-100 dark:bg-slate-700">
                  <tr>
                    ...
                    <th className="border border-slate-300 dark:border-slate-600 px-4 py-2 font-semibold">Цена</th>
                  </tr>
                </thead>
                <tbody className="text-slate-600 dark:text-slate-400">
                  <tr>
                    <td className="border border-slate-300 dark:border-slate-600 px-4 py-2 font-medium">Claude 3.5 Sonnet</td>
                    <td className="border border-slate-300 dark:border-slate-600 px-4 py-2">Лучший баланс цена/качество</td>
                    <td className="border border-slate-300 dark:border-slate-600 px-4 py-2">✅ Да</td>
                    <td className="border border-slate-300 dark:border-slate-600 px-4 py-2">Средняя</td>
                  </tr>
                  <tr className="bg-slate-50 dark:bg-slate-800">
                    <td className="border border-slate-300 dark:border-slate-600 px-4 py-2 font-medium">Claude 3.5 Haiku</td>
                    <td className="border border-slate-300 dark:border-slate-600 px-4 py-2">Быстрый и дешёвый</td>
                    <td className="border border-slate-300 dark:border-slate-600 px-4 py-2">✅ Да</td>
                    <td className="border border-slate-300 dark:border-slate-600 px-4 py-2">Низкая</td>
                  </tr>
                  <tr>
                    <td className="border border-slate-300 dark:border-slate-600 px-4 py-2 font-medium">Claude 3.7 Sonnet</td>
                    <td className="border border-slate-300 dark:border-slate-600 px-4 py-2">Новейший, улучшенный</td>
                    <td className="border border-slate-300 dark:border-slate-600 px-4 py-2">✅ Да</td>
                    <td className="border border-slate-300 dark:border-slate-600 px-4 py-2">Средняя</td>
                  </tr>
                  <tr className="bg-slate-50 dark:bg-slate-800">
                    <td className="border border-slate-300 dark:border-slate-600 px-4 py-2 font-medium">Claude Sonnet 4</td>
                    <td className="border border-slate-300 dark:border-slate-600 px-4 py-2">Топовое качество</td>
                    <td className="border border-slate-300 dark:border-slate-600 px-4 py-2">✅ Да</td>
                    <td className="border border-slate-300 dark:border-slate-600 px-4 py-2">Высокая</td>
                  </tr>
                  <tr>
                    <td className="border border-slate-300 dark:border-slate-600 px-4 py-2 font-medium">Claude Opus 4</td>
                    <td className="border border-slate-300 dark:border-slate-600 px-4 py-2">Самый умный, сложные задачи</td>
                    <td className="border border-slate-300 dark:border-slate-600 px-4 py-2">✅ Да</td>
                    <td className="border border-slate-300 dark:border-slate-600 px-4 py-2">Премиум</td>
                  </tr>
                </tbody>
              </table>
            </div>
              ...
              <table className="w-full border-collapse border border-slate-300 dark:border-slate-600 text-left">
                ...
                <tbody className="text-slate-600 dark:text-slate-400">
                  <tr>
                    ...
                    <td className="border border-slate-300 dark:border-slate-600 px-4 py-2">Универсальная, быстрая</td>
                    <td className="border border-slate-300 dark:border-slate-600 px-4 py-2">✅ Да</td>
                    <td className="border border-slate-300 dark:border-slate-600 px-4 py-2">Средняя</td>
                  </tr>
                  <tr className="bg-slate-50 dark:bg-slate-800">
                    <td className="border border-slate-300 dark:border-slate-600 px-4 py-2 font-medium">GPT-4o-mini</td>
                    <td className="border border-slate-300 dark:border-slate-600 px-4 py-2">Дешёвая для простых задач</td>
                    <td className="border border-slate-300 dark:border-slate-600 px-4 py-2">✅ Да</td>
                    <td className="border border-slate-300 dark:border-slate-600 px-4 py-2">Низкая</td>
                  </tr>
                  <tr>
                    <td className="border border-slate-300 dark:border-slate-600 px-4 py-2 font-medium">GPT-4 Turbo</td>
                    <td className="border border-slate-300 dark:border-slate-600 px-4 py-2">Длинный контекст 128K</td>
                  ...
                  <tr className="bg-slate-50 dark:bg-slate-800">
                    ...
                    <td className="border border-slate-300 dark:border-slate-600 px-4 py-2">Логика и рассуждения</td>
                    <td className="border border-slate-300 dark:border-slate-600 px-4 py-2">❌ Нет</td>
                    <td className="border border-slate-300 dark:border-slate-600 px-4 py-2">Высокая</td>
                  </tr>
                  <tr>
                    <td className="border border-slate-300 dark:border-slate-600 px-4 py-2 font-medium">o1-pro</td>
                    <td className="border border-slate-300 dark:border-slate-600 px-4 py-2">Максимум для сложных задач</td>
                    <td className="border border-slate-300 dark:border-slate-600 px-4 py-2">❌ Нет</td>
                    <td className="border border-slate-300 dark:border-slate-600 px-4 py-2">Премиум</td>
                  </tr>
                </tbody>
