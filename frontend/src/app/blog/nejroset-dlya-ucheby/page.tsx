        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-lg prose-slate dark:prose-invert max-w-none">
            ...
            <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-xl p-6 my-6">
              <p className="text-yellow-900 dark:text-yellow-100 font-medium text-lg mb-2">⚠️ Важно</p>
            ...
            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mt-10 mb-4">Как AI помогает в учёбе</h2>
            ...
            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mt-10 mb-4">Какую нейросеть выбрать</h2>
            ...
            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mt-10 mb-4">Примеры промптов для учёбы</h2>
            ...
            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mt-10 mb-4">Этичное использование</h2>

            <div className="grid md:grid-cols-2 gap-4 my-6">
              <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-xl p-5">
                <h3 className="font-bold text-green-900 dark:text-green-100 mb-2">✅ Это нормально:</h3>
              ...
              <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-xl p-5">
                <h3 className="font-bold text-red-900 dark:text-red-100 mb-2">❌ Это плохо:</h3>
