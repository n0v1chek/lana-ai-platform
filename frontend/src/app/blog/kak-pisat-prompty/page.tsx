      ...
      <article className="py-12 px-4">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <span className="text-slate-300">|</span>
            <span className="text-slate-500">12 мин чтения</span>
          </div>
          ...
          <div className="prose prose-lg prose-slate max-w-none">
            ...
            <h2 className="text-2xl font-bold text-slate-900 mt-10 mb-4">Главное правило</h2>
            ...
            <div className="grid md:grid-cols-2 gap-4 my-6">
              <div className="bg-red-50 border border-red-200 rounded-xl p-5">
                <h3 className="font-bold text-red-900 mb-2">❌ Плохо</h3>
                <p className="text-red-800 text-sm italic">"Напиши текст про маркетинг"</p>
              </div>
              <div className="bg-green-50 border border-green-200 rounded-xl p-5">
                <h3 className="font-bold text-green-900 mb-2">✅ Хорошо</h3>
            ...
            <h2 className="text-2xl font-bold text-slate-900 mt-10 mb-4">Формула хорошего промпта</h2>
            ...
            <h2 className="text-2xl font-bold text-slate-900 mt-10 mb-4">Примеры промптов по задачам</h2>
            ...
            <h2 className="text-2xl font-bold text-slate-900 mt-10 mb-4">Продвинутые техники</h2>
            ...
            <h2 className="text-2xl font-bold text-slate-900 mt-10 mb-4">Чего избегать</h2>
            ...
            <h2 className="text-2xl font-bold text-slate-900 mt-10 mb-4">Итерации — ключ к успеху</h2>
            <p className="text-slate-600 mb-4">
